package edu.ucsb.cs56.w16.drawings.yanxi.simple;
...
{  
	...
	Circle topCircle = new Circle(snowManCenterBottomX, snowManCenterBottomY - bottomRadius*2 - middleRadius*2 - topRadius, topRadius);
	g2.draw(topCircle);
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Yanxi Chen's snowman!!!", 20,20);
