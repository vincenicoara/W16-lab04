package edu.ucsb.cs56.w16.drawings.shouzhiwan.simple;
...
public class PictureViewer
{
	...
	frame.setSize(680,320); // @@@ MODIFY THIS LINE IF YOU LIKE
	
	// Set your own title
	frame.setTitle("Shouzhi Wan's Drawing"); // @@@ MODIFY THIS LINE
