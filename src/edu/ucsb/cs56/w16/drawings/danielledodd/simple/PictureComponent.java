package edu.ucsb.cs56.w16.drawings.danielledodd.simple;
...
/**
   ...
   @author Danielle Dodd (fixed the snowmans's head)
...
{  
	...
	g2.drawString("The Snowman and House by Danielle Dodd", 20,20);
