package edu.ucsb.cs56.w16.drawings.giovanni_rojas.simple;
...
/**
   ...
   @author Giovanni Rojas (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("My beautiful unique snowman :) by Giovanni Rojas", 20,20);
