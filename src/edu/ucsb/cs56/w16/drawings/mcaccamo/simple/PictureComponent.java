package edu.ucsb.cs56.w16.drawings.mcaccamo.simple;
...
{  
	...
	Circle snowManHead = new Circle (snowManCenterBottomX, snowManCenterBottomY - bottomRadius *2 - middleRadius *2 - topRadius, topRadius);
	g2.draw(snowManHead);
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Snowman and House - Michael Caccamo", 20,20);
